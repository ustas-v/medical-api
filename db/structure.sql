...
CREATE TABLE public.procedures (
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    name_tsvector tsvector GENERATED ALWAYS AS (setweight(to_tsvector('english'::regconfig, (COALESCE(name, ''::character varying))::text), 'A'::"char")) STORED
);
...
--
-- Name: index_procedures_on_name_tsvector; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_procedures_on_name_tsvector ON public.procedures USING gin (name_tsvector);
